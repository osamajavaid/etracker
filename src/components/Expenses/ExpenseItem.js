...
function ExpenseItem(props){
  ...
  return (
    <div className='my-6 flex justify-center items-center'>
        <Card className='flex bg-blue-900 px-4 space-x-3 md:space-x-6 lg:space-x-10 sm:bg-red-500 w-[80%] sm:w-[50%] md:w-[60%] lg:w-[70%] h-28 md:bg-slate-700 lg:bg-red-500 xl:bg-fuchsia-700 xl:space-x-16  items-center justify-between sm:px-1 md:px-3 lg:px-5 xl:px-5 shadow-2xl'>
